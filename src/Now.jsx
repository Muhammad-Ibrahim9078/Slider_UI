...
function MainContent({
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-black">
      ...
      {/* CONTENT */}
      <div className="relative z-20 h-full flex flex-col justify-end p-4 md:p-6 lg:p-8">
        <section className="flex flex-col lg:flex-row justify-between flex-wrap items-start lg:items-center gap-6 md:gap-8">
  ...
  <button
    className="
      ...
      text-black flex items-center justify-center gap-2 md:gap-3
  ...
  >
    ...
    <VscDebugStart className="w-4 h-4 md:w-5 md:h-5 pointer-events-none" />
          ...
          {/* RIGHT CARDS WITH HEADINGS (connected to bg via layoutId) */}
        ...
        {/* BOTTOM CONTROLS */}
        <div className="fixed left-0 right-0 bottom-0 z-50 pb-4 md:pb-8">
